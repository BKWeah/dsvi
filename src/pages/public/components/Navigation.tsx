        ...
        <div className="flex justify-between items-center">
          ...
          <div ref={logoRef}>
            <Link to="/" className="flex items-center space-x-3 group">
              <img src="/updates_assets/DSVI Official Logo.png" alt="GyaWe School Solutions Logo" className="h-10 w-10 object-contain group-hover:scale-110 transition-transform duration-300" />
              <div>
