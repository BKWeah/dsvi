...
BEGIN
    ...
    -- Generate signup link (base URL will be added by frontend)
    ...
    -- Return success with invitation details (including email_hash)
...
SELECT 'Admin invitation function fixed!' as status;
